...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: "Pooja Addons", path: "/admin/addons", icon: FiSettings },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 bg-white border-r border-gray-200 shadow-sm transition-all duration-300 ease-in-out ${isSidebarOpen ? "w-64" : "w-20"
          } lg:relative`}
      >
        <div className="h-full flex flex-col">
          ...
          <nav className="flex-1 p-4 space-y-2">
            {navItems.map((item) => (
              ...
              >
                ...
                <span className={`font-medium transition-opacity duration-200 ${isSidebarOpen ? "opacity-100" : "opacity-0 hidden lg:block lg:w-0 lg:overflow-hidden"
                  }`}>
          ...
          <div className="p-4 border-t border-gray-100">
            ...
            <button
              ...
              className={`mt-4 w-full flex items-center gap-3 px-3 py-2 rounded-xl text-red-600 hover:bg-red-50 transition-all duration-200 ${!isSidebarOpen && "justify-center"
                }`}
            >
