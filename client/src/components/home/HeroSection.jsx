                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-4xl">
                            <Link to="/muhurat"
                                ...
                                <span className="tracking-widest text-sm md:text-base">TODAY'S MUHURAT</span>
                            </Link>
                            <Link to="/poojas"
                                ...
                                <span className="material-symbols-outlined text-3xl group-hover:scale-110 transition-transform">temple_hindu</span>
                                <span className="tracking-widest text-sm md:text-base">BOOK A POOJA</span>
                            </Link>
                            <Link to="/temples"
                                ...
                                <span className="material-symbols-outlined text-3xl group-hover:scale-110 transition-transform">temple_hindu</span>
                                <span className="tracking-widest text-sm md:text-base">TEMPLES NEARBY</span>
                            </Link>
                        </div>
                    </div>
                </div>
