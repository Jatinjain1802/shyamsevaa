...
--
ALTER TABLE `chadawas` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `poojas` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `temples` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `chadawas` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `poojas` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `temples` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
